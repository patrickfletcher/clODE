...
- [ ] P1 Explicit observer-definition model: params, persistent state, event storage, warmup, feature names. depends: continuation semantics. blocks: custom/composable observers. refs: `clode/features.py`, `clode/_pyopencl/observer_metadata.py`, `clode/kernels/observers.cl`
- [ ] P1 Separate persistent observer state from optional event-output capacity. depends: explicit observer-definition model. refs: `clode/_pyopencl/observer_metadata.py`, `clode/kernels/features.cl`, `tmp/development_roadmap.md`
...
- [ ] P2 Audit Python-level source assembly vs current `#define`/`#include` model. refs: `clode/_pyopencl/source_builder.py`, `clode/kernels/`, `tmp/archived/pyopencl_cleanup_closeout_2026_05_08/pyopencl_backend_design.md`
- [ ] P1 Leverage PyOpenCL compiler cache, `MemoryPool`, `capture_call`, and `characterize` utilities before adding more custom runtime helpers. refs: `clode/_pyopencl/runtime.py`, `clode/_pyopencl/program_cache.py`, `clode/_pyopencl/buffers.py`, `tmp/pyopencl_leverage_audit.md`
...
- [ ] P1 Kernel-component tests with tiny synthetic models and kernels beyond end-to-end simulator tests. refs: `test/core_numerics/`, `clode/_pyopencl/source_builder.py`, `tmp/testing_audit.md`
- [ ] P1 Cache/build-key/invalidation coverage around program rebuilds and observer changes. refs: `clode/_pyopencl/program_cache.py`, `clode/_pyopencl/source_builder.py`, `clode/features.py`
