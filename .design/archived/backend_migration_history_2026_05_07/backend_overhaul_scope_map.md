...
Status: historical migration-planning reference. For the active rollout policy and current validation commands after PR 16, use `.design/backend_pr_task_breakdown.md` and `.design/pyopencl_rollout_guardrails.md`.
...
| `.design/` | Active migration docs, scope docs, test-suite docs, task planning | Yes | Current durable planning memory during the backend prep phase |
...
The exact suite definition is pinned in `.design/archived/backend_migration_history_2026_05_07/backend_core_test_suite.md`.
...
| Where are the PyOpenCL host struct layout rules | `clode/_pyopencl/structs.py`, `.design/pyopencl_struct_audit.md` |
| Where is the PyOpenCL transient executor | `clode/_pyopencl/executors.py` |
| What is the current rollout policy and stable runtime | `.design/pyopencl_rollout_guardrails.md`, `docs/install.md` |
| What is the current build key | `.design/cpp_opencl_layer_audit.md`, `clode/cpp/CLODE.cpp` |
| How is the current program assembled | `.design/cpp_opencl_layer_audit.md`, `clode/cpp/CLODE.cpp`, `clode/cpp/transient.cl`, `clode/cpp/features.cl` |
| Which public APIs must remain stable | `clode/solver.py`, `clode/trajectory.py`, `clode/features.py`, `.design/pyopencl_backend_design.md` |
| What is the current array layout | `.design/cpp_opencl_layer_audit.md`, `clode/solver.py`, `clode/trajectory.py`, `clode/features.py` |
...
| Which tests must not be used as parity authority | This document and `.design/archived/backend_migration_history_2026_05_07/backend_core_test_suite.md` |

## Lookup Priority Rules

When context is short, consult files in this order.

1. `.design/pyopencl_backend_design.md`
2. `.design/archived/backend_migration_history_2026_05_07/backend_core_test_suite.md`
3. This document
4. `.design/cpp_opencl_layer_audit.md`
