...
Status: historical migration-planning reference. The active rollout gate after PR 16 is tracked in `.design/pyopencl_rollout_guardrails.md` and `.design/backend_pr_task_breakdown.md`.
...
- `.design/pyopencl_rollout_guardrails.md` is the authoritative rollout-policy note for PR 12 and later
