...
- `.design/archived/backend_migration_history_2026_05_07/`

Keep in `.design/` for now:

- `.design/backend_pr_task_breakdown.md`
- `.design/pyopencl_rollout_guardrails.md`
- `.design/pyopencl_packaging_release_audit.md`
- `.design/ci_cleanup_plan.md`
- `.design/pyopencl_backend_design.md`
- `.design/pyopencl_post_migration_plan.md`
- `.design/cpp_opencl_layer_audit.md`
- `.design/pyopencl_struct_audit.md`
- `.design/python_simulation_flow_reference.md`

The last three are still useful while the comparison path exists. Once the wrapper-removal PR lands, they should move to `.design/archived/` as well.
