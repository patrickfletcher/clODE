...
- Current active planning is the oscillation-oriented bundle seam in `.design/next_pr.md`.
...
- Shared seam vs family-local duplication for oscillation-oriented controls/readouts.
