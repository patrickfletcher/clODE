...
- `ivp_api_test_plan.md`: active PR guide for first-pass `InitialValueProblem` API shape, staged delivery order, Python-backed callability, and the slim test matrix.
