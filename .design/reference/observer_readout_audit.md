...
**Scope**: Generalize `ThresholdCrossingReadoutSelection` pattern to other families (conditional).
...
- Implement readout-selection types for families with optional readouts (e.g., `LocalExtremumReadoutSelection`)
