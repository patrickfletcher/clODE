...
- [ ] P1 Single-source-of-truth solution-buffer or solver-state kernel abstraction plus shared update helpers for steppers and observers after the explicit solver-state model lands. depends: explicit solver-state model. refs: `clode/kernels/observers.cl`, `clode/kernels/transient.cl`, `clode/kernels/features.cl`, `.design/reference/semantic_layout_audit.md`
