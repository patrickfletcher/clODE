...
- [ ] P1 Observer-state and register-pressure audit for the heavier feature kernels: trim avoidable private scratch, quantify `max_event_timestamps` and per-observer state costs, and keep low-risk tidy-ups separate from deeper observer-time redesign. refs: `clode/kernels/observers/observer_local_maximum.clh`, `clode/kernels/observers/observer_neighborhood_1.clh`, `clode/kernels/observers/observer_neighborhood_2.clh`, `clode/kernels/observers/observer_threshold_2.clh`, `docs/performance_notes.md`
