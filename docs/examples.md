...
- [visualize_events_local_extremum.py](https://github.com/patrickfletcher/clODE/blob/main/examples/visualize_events_local_extremum.py): visualize the sampled slope sign-change trigger and three-sample quadratic refinement used by `local_extremum`.
