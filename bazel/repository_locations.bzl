REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    _com_github_KhronosGroup_OpenCLHeaders = dict(
        project_name = "OpenCL API Headers",
        project_desc = "This repository contains C language headers for the OpenCL API.",
        project_url = "https://github.com/KhronosGroup/OpenCL-Headers",
        version = "2023.02.06",
        sha256 = "8289bfdc3839affa635e6f174f0297e94215e1d7279f287a7b068ac5db3fe5af",
        strip_prefix = "opencl_headers-{version}",
        urls = ["https://github.com/KhronosGroup/OpenCL-Headers/archive/refs/tags/v{version}.zip"],
        use_category = ["dataplane_core", "controlplane"],
