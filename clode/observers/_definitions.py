...
def _normalized_neighborhood_return_feature_names(
    ...
    names.extend(["period max", "period min", "period mean"])
...
def _localmax_layout(
    ...
    return ResolvedObserverLayout(
        persistent_fields=(
            ...
            _real_field("xTrajectoryIntegralCorrection", real_dtype, problem_info.num_var),
...
def _normalized_neighborhood_return_layout(
    ...
    return ResolvedObserverLayout(
        persistent_fields=(
            ...
            _real_field("xGlobalMax", real_dtype),
            _real_field("xGlobalMin", real_dtype),
            _real_field("xWarmupMax", real_dtype),
            _real_field("xWarmupMin", real_dtype),
